...
[Android Jetpack][1]是一系列助力更容易打造卓越 Android 应用的工具和组件。这些组件能帮助您遵循最佳实践、免除编写繁复的样板代码并简化复杂任务，从而使您可以专注于最核心的代码逻辑。
...
本文记录[Android Jetpack][2]架构组件（Architecture）中的[ViewModel][3]。
...
至此，`ViewModelProviders.of(xx).get(xxx)`分析完毕。
  ...
  [3]: https://developer.android.google.cn/topic/libraries/architecture/viewmodel
  [4]: https://developer.android.google.cn/images/topic/libraries/architecture/viewmodel-lifecycle.png