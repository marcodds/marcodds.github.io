...
(function() {
  ...
  var demoContent = [
    {
      demo_link: 'https://github.com/qfxl/MarqueeView',
      img_link: 'https://github.com/qfxl/MarqueeView/blob/master/gif/sample.gif?raw=true',
      code_link: 'https://github.com/qfxl/MarqueeView',
      title: 'Android MarqueeView',
      core_tech: 'MarqueeView',
      description: 'Android MarqueeView。'
    }
  ];
